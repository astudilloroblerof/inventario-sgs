			...
			<table border="1" rules="rows" id="categories" >
				<thead>
					<tr>
						...
						<td width="14%">Insumos vinculados</td>
						<td width="17%">Total de Insumos</td>
...
?>
					<tr data-type="element" data-id="<?php echo $cat->id;?>">
						...
						<td>
							<?php
							if($role == 1 || $role == 2)
								echo '<a href="edit-category.php?id='.$cat->id.'" name="c3" title="Editar Items"><i class="fa fa-pencil"></i></a>';
							if($role == 1 || $role == 2 || $role == 3)
								echo '<a href="logs.php?catid='.$cat->id.'" name="c4" title="Log de la Categoria"><i class="fa fa-file-text-o"></i></a>';
							if($role == 1 || $role == 2)
