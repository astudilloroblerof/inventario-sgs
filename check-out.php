...
if(isset($_GET['search']) && ($_GET['search'] != '')){
	...
	$s = false;
	$items = $_items->get_items1($page, $pp);
...
<body>
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			<h2 class="noborder">Descuento de Stock</h2>
			<span class="downtitle">Selecciona el insumo al cual deseas descontar Stock</span>
			<div id="table-head">
			...
			<table border="1" rules="rows" id="items-check">
				<thead>
					<tr>
						<td width="7%">ID</td>
						<td width="48%">Insumos</td>
						<td width="27%">Categoría</td>
