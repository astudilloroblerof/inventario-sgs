...
if(isset($_GET['search']) && ($_GET['search'] != '')){
	...
	$s = false;
	$items = $_items->get_items($page, $pp, $hoja);
	...
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			...
			<div id="table-head">
				...
				?>
				<a href="" name="check-out-all" class="btn blue disabled fright"><i class="fa fa-arrow-down"></i>Descontar</a>

			<?php
				// Add Item only for Admin, General Supervisor and Supervisor
				if($headrole == 1 || $headrole == 2 || $headrole == 3 || $headrole == 4){
				?>
					<a href="" name="check-in-all" class="btn green disabled fright"><i class="fa fa-arrow-up"></i>Agregar</a>
			<?php
			}
			?>	
				</div>
...
?>
					<tr data-type="element" data-id="<?php echo $item->id; ?>">
						...
						<td class="hover" data-type="cat"><?php echo $item->descrp ?></td>
				...
				if($headrole == 1 || $headrole == 2 || $headrole == 3 || $headrole == 4){
				?>
							<a href="" name="c1" title="Ingreso"><i class="fa fa-arrow-up"></i></a>

				<?php
				}
				?>	
							<a href="" name="c2" title="Salida"><i class="fa fa-arrow-down"></i></a>
							<?php
							if($role == 1 || $role == 2)
