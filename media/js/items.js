$('document').ready(function() {
		...
		for(var i = 0; i < selected.length; i++) {
			...
			if($('input[type=checkbox][name=chbox][value="'+id+'"]').parent().parent().next().data('id') != 'y') {
				if(getViewportWidth() > 420)
					...
					var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td>"+text+"</td><td></td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+act+"\"><input type=\"text\" class=\"num\" placeholder=\"Cant.\" /></form></td><td><input type=\"submit\" value=\"Guardar\" class=\"btn blue save "+act+"\" /></td><td></td></tr>");
				else
	...
	$('a[name=delete-all]').click(function(evt) {
		...
		if(confirm('Estas seguro que quieres eliminar '+selected.length+' productos?')) {
			...
			$.post('items.php', {
				...
				if(data == 'wrong') {
					die('Algo salió mal. Por favor, inténtelo de nuevo');
					return false;
				}
	...
	function check_item(act, t) {
		...
		if($('input[type=checkbox][name=chbox][value="'+id+'"]').parent().parent().next().data('id') != 'y') {
			if(getViewportWidth() > 420)
				var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td></td><td>"+text+"</td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+act+"\"><input type=\"text\" class=\"num\" placeholder=\"Cant\" /><input type=\"text\" class=\"text\" placeholder=\"Comentario\" /></form></td><td><input type=\"submit\" value=\"Guardar\" class=\"btn blue save "+act+"\" /></td><td></td></tr>");
			else if(getViewportWidth() <= 420 && getViewportWidth() > 370)
				var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td>"+text+"</td><td></td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+act+"\"><input type=\"text\" class=\"num\" placeholder=\"Cant\" /><input type=\"text\" class=\"text\" placeholder=\"Comentario\" /></form></td><td></td><td><input type=\"submit\" value=\"Guardar\" class=\"btn blue save "+act+"\" /></td><td></td></tr>");
			else
				var cont = $("<tr style=\"display:none\" data-id=\"y\"><td></td><td></td><td>"+text+"</td><td></td><td><form method=\"post\" data-saveid=\""+id+"\" name=\""+act+"\"><input type=\"text\" class=\"num\" placeholder=\"Cant\" /><input type=\"text\" class=\"text\" placeholder=\"Comentario\" /></form></td><td></td><td><input type=\"submit\" value=\"Guardar\" class=\"btn blue save "+act+"\" /></td><td></td></tr>");
			element.after(cont);
	...
	$('form[name=searchf]').submit(function(evt) {
		...
		$.post('repuestos.php', {
			...
			if(data == '3') {
				location.href = 'repuestos.php?search='+encodeURIComponent(val);
				$('.loader').fadeOut(200);
				return false;
			}
			if(data == '2') {
	...
	$('form[name=searchf]').submit(function(evt) {
		...
		$.post('insumos.php', {
			...
			if(data == '3') {
				location.href = 'insumos.php?search='+encodeURIComponent(val);
				$('.loader').fadeOut(200);
				return false;
			}
			if(data == '2') {
	...
	function go(act, val) {
		...
		if(search != undefined) url = url+'&search='+search;
		location.href = 'repuestos.php?'+url;
	}
