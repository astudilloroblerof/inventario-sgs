...
if(isset($_POST['act'])) {
	if($_POST['act'] == '1') {
		if(!isset($_POST['itemid']) || !isset($_POST['name']) || !isset($_POST['desc']) || !isset($_POST['cat']))
			die('wrong');
		if($_POST['itemid'] == '' || $_POST['name'] == '' || $_POST['cat'] == '')
			die('wrong');
...
<body>
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			<h2>Editar insumos (ID <?php echo $itemid; ?>)</h2>
			<div class="center">
				<div class="new-item form">
					<form method="post" action="" name="edit-item" data-id="<?php echo $itemid; ?>">
						...
						?>
						<span class="item-desc-left">Ubicación (<?php echo $desc; ?> caracteres restantes):</span><br />
						<div class="ni-cont">
