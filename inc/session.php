...
class Session {
	...
	public function get_user_name_by_id($id) {
		$prepared = $this->prepare("SELECT name FROM invento_users WHERE id=?", 'get_user_name_by_id()');
	...
	public function get_user_name() {
		...
		$prepared = $this->prepare("SELECT name FROM invento_users WHERE id=?", 'get_user_name()');
		$this->bind_param($prepared->bind_param('i', $id), 'get_user_name()');
		$this->execute($prepared, 'get_user_name()');
