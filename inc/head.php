<?php
$_titles = array('','Inicio','Nuevo producto','Productos','Ingresos','Salidas','Logs','Categorías','Nueva categoría','Usuarios','Nuevo usuario','Editar usuario','Configuración','Editar producto','Editar categoría','Detalle de categoría','Detalle del producto','Detalle del usuario', '18','19', '20','21');
$_title = $_titles[$_page];
?>
	<meta charset="utf-8" />
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1, user-scalable=no" />
	<title>Inventario SGS- <?php echo $_title; ?></title>
...
switch($_page) {
	...
	case 20: echo '	<script type="text/javascript" src="media/js/items.js"></script>'; break;
	case 21: echo '	<script type="text/javascript" src="media/js/items.js"></script>'; break;
} ?>